...
<#
.SYNOPSIS
    Claude Code + OpenClaw Backup v22.0 - LEAN BLITZ
.DESCRIPTION
    Zero-garbage backup: only useful data, real-time progress, system cleanup.
    v22.0: Adds scheduled task XMLs, .anthropic dir, .local/share/claude, env files.
...
Write-Host "  CLAUDE CODE + OPENCLAW BACKUP v22.0 LEAN BLITZ" -ForegroundColor White
