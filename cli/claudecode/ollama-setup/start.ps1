...
$env:OLLAMA_CONTEXT_LENGTH    = '131072'   # 128K tokens (262144 causes OOM on 14.5GB)
...
Write-Step 'Env set: GPU=0 LAYERS=999 CTX=131072 KV=q4_0 BATCH=2048 FA=1' 'Green'
...
if ($present) {
    ...
    Write-Step 'Pulling qwen3.5:latest base model...' 'Yellow'
...
Write-Host '  OLL90 READY - RTX 5080 Optimized Configuration'     -ForegroundColor Cyan
Write-Host '======================================================' -ForegroundColor Cyan
Write-Host "  Model:      $MODEL_NAME (9.7B qwen3.5 Q4_K_M)"
Write-Host '  GPU Layers: 33/33 (100% GPU, RTX 5080)'
...
Write-Host '  Batch:      2048 (GGML pool limit at 4096 on v0.20.2)'
...
# ===========================================================================
# STEP 9: DISPATCH — -Web or terminal agent
# ===========================================================================
if ($Web) {
